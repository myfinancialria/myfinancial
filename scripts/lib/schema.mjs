...
export const STOCK_FIELDS = [
  ...
  { key: "sectorCapSharePct", label: "Share of sub-sector", group: "Company", unit: "%", dir: 1, type: "num", help: "This company's market capitalisation as a share of every listed company in its sub-sector combined. A measurable stand-in for market position — it is a share of listed value, not a share of revenue." },
