...
const KNOWN = ["MYFIN_PROVIDER", "UPSTOX_ACCESS_TOKEN", "UPSTOX_API_KEY", "UPSTOX_API_SECRET", "UPSTOX_REDIRECT_URI", "FYERS_APP_ID", "FYERS_ACCESS_TOKEN", "AIMLAPI_KEY", "AIMLAPI_MODEL"];
const SECRET_KEYS = new Set(["UPSTOX_ACCESS_TOKEN", "UPSTOX_API_SECRET", "FYERS_ACCESS_TOKEN", "AIMLAPI_KEY"]);
